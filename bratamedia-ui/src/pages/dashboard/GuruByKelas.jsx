...
const GuruByKelas = () => {
  ...
  // Function Pulling
  const getDataGuruByKelas = async () => {
    setLoading(true);
    try {
      const res = await axios.get(
        `${
          import.meta.env.VITE_API_ENDPOINT
        }/kelas/gurubykelas?page=${page}&search=${valueSearch}`,
        {
  ...
  return (
    <div>
      {/* Judul Halaman */}
      <h2 className='text-2xl font-bold mb-4'>Data Guru Berdasarkan Kelas</h2>
      ...
      <div className='mb-4 flex items-center space-x-2'>
        ...
        <input
          id={"search"}
          type='text'
          placeholder='Cari Nama Guru atau Nama Kelas'
        ...
        <table className='w-full border-collapse'>
          <thead>
            <tr className='bg-gray-200 py-2'>
              ...
              <th className='p-3 text-left'>Daftar Guru</th>
            </tr>
          </thead>
          <tbody>
